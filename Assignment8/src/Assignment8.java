               ...
               if (line.length() == 1)          //check if a user entered only one character
               {
                   switch (input1)
                   {
                       ...
                       case 'U':  //Write Text to a File
                           ...
                           {
                        	   System.out.println(filename + "Failed writing");
                           }
                           finally
                           {
                        	   outFile.close();
                   ...
                   case 'W':  //Serialize ProjectManagement to a File
                           ...
                           {
                        	   System.out.print("failed to serialize");
                           }
                           break;
                       case 'X':  //Deserialize ProjectManagement from a File
                           ...
                           try
                           {
                        	   ...
                        	   manage1 = (ProjectManagement) ois.readObject();
                        	   System.out.print(filename + " was read\n");
                           ...
                           {
                        	   System.out.print(filename + "was not found object");
                           }
                           break;
                       case '?':   //Display Menu
                           printMenu();
