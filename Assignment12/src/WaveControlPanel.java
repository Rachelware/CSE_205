       ...
       public void actionPerformed(ActionEvent event)
        {
            ...
            if (action == start) //when start button pressed wave restarts
            {
            	wPanel.resume();
            }
            if (action == clear) //when clear button pressed panel clears
            {
            	wPanel.clearPanel();
            }
            if (action == colorButton)	//when color button pressed popup shows
             {
